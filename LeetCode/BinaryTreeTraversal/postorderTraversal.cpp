...
list<int>* postorderTraversal(TreeNode* root) {
	cout << "postorderTraversal is start" << endl;
	...
	while (node != NULL) {
		...
		if (nodeState == nodeLeft) {
		 ...
		 postorderResult->push_back(node->val);
	...
	cout << "postorderTraversal is end" << endl;
...
int main() {
	...
	list <int>* listResult = postorderTraversal(treeNode1);
	int listsize = listResult->size();
	cout << "postorderTraversal listsize : " << listsize << endl;;
